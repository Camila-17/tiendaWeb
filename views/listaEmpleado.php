<?php
    include("../controllers/listadoEmpleadosControlador.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="../public/listaEmpleado.css">
</head>
                ...
                <div class="col">
                    <div class="card h-100"> 
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editar<?= $empleado["id"] ?>"><i class="far fa-edit"></i></a>
                        </div>
                    </div>
                    
                    <section>
                        <div class="modal fade" id="confirmacion<?= $empleado["id"] ?>" tabindex="-1"   aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="../controllers/controladorEliminarEmpleados.php?id=<?= $empleado["id"]?>" class="btn btn-primary">Aceptar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section>
                        <div class="modal fade" id="editar<?= $empleado["id"] ?>" tabindex="-1"   aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Sumila</h5>
