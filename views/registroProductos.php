...
<body class="fondo">
    ...
    <main class="">
        <h3 class="text-center mt-3 registro ">REGISTRO PRODUCTOS</h3>
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class=" col-12 col-md-5">
                    <form class="  p-4" action="../controllers/productosControl.php"
                        method="POST">
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label letrasMenu">Nombre producto</label>
                                <input type="text" class=" border border-dark form-control fondoinput " name="nombresProducto">
                            </div>
                            <div class="col mb-3">
                                <label class="form-label letrasMenu">Marca producto</label>
                                <input type="text" class="border border-dark form-control fondoinput" name="marcaProducto">
                            </div>
                        </div>
                    
                        <div class="mb-3">
                            <label class="form-label letrasMenu">Precio producto</label>
                            <input type="text" class=" border border-dark form-control fondoinput" name="precioProducto">
                        </div>
                        <div class="mb-3">
                            <label class="form-label letrasMenu">Fotografia producto</label>
                            <input type="text" class=" border border-dark form-control fondoinput" name="fotoProducto">
                            
                        </div>
                        <div class="mb-3">
                            <label class="form-label letrasMenu">Descripcion producto</label>
                            <textarea class= " border border-dark form-control fondoinput" name="descripcionProducto" placeholder=""
                        ...
                        <div class="botonCenter">
                            <button type="submit" class="btn btn-outline-dark w-100" name="recoleccionProducto">Registrar</button>
                        </div>
